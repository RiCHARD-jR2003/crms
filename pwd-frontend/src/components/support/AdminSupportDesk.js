                            ...
                            <Box sx={{ mt: 1 }}>
                              ...
                              {message.attachment_type && message.attachment_type.startsWith('image/') ? (
                                <Box sx={{ 
                                  ...
                                  <img
                                    src={`${API_CONFIG?.API_BASE_URL || 'https://farming-artists-representing-houston.trycloudflare.com/api'}/support-tickets/messages/${message.id}/image`}
                                    ...
                                    onError={(e) => {
                                      const imageUrl = `${API_CONFIG?.API_BASE_URL || 'https://farming-artists-representing-houston.trycloudflare.com/api'}/support-tickets/messages/${message.id}/image`;
