...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear <strong><?php echo e($fullName); ?></strong>,</p>

            <p>This is a reminder that your PWD (Persons with Disabilities) ID card will expire soon.</p>

            <div class="warning-box">
                <div class="days-remaining"><?php echo e($daysRemaining); ?> Days Remaining</div>
                <p style="text-align: center; margin: 10px 0 5px 0;"><strong>Expiration Date:</strong> <?php echo e(\Carbon\Carbon::parse($expirationDate)->format('F d, Y')); ?></p>
            </div>

            <div class="info-box">
                <p style="margin: 5px 0;"><strong>PWD ID Number:</strong> <?php echo e($pwdId); ?></p>
                <p style="margin: 5px 0;"><strong>Barangay:</strong> <?php echo e($barangay); ?></p>
            </div>

            <div class="instructions-box">
                <h3 style="margin-top: 0; color: #F39C12;">📋 Renewal Instructions:</h3>
                <p style="margin: 5px 0;"><?php echo e($renewalInstructions); ?></p>
                <p style="margin: 10px 0 5px 0;"><strong>Office Location:</strong> <?php echo e($officeAddress); ?></p>
                <p style="margin: 5px 0;"><strong>Contact Number:</strong> <?php echo e($contactNumber); ?></p>
            </div>
...
<?php /**PATH C:\Users\Ivan\Desktop\crms\pwd-backend\resources\views/emails/id-renewal-reminder.blade.php ENDPATH**/ ?>