...
return [
    ...
    */
    ...
    'allowed_origins' => [
        ...
        'https://spyware-justice-knock-nutrition.trycloudflare.com', // Current backend tunnel
        'https://triangle-sending-principal-roland.trycloudflare.com', // Current frontend tunnel
    ],
