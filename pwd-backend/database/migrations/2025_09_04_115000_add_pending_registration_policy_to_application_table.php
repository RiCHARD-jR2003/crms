...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        // Update status column to string using raw SQL (avoids DBAL dependency)
        \Illuminate\Support\Facades\DB::statement('ALTER TABLE application MODIFY COLUMN status VARCHAR(50)');
