...
class CreateSanitoMendozaAccountSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $email = 'sanitomendoza01@gmail.com';
        $firstName = 'Sanito';
        $lastName = 'Mendoza';
        $age = 62;
        ...
        $this->command->info('✅ Account created successfully for Sanito Mendoza:');
        ...
        $this->command->info('   - Disability: Hearing Impairment');
