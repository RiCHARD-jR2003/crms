...
<body>
    ...
    <div class="content">
        ...
        <div class="schedule-box">
            ...
            <div class="date">{{ \Carbon\Carbon::parse($assessment->assessment_date)->format('F d, Y') }}</div>
            <div class="time">🕐 {{ $timeSlot }}</div>
        </div>
        
        <p>Reference Number: <span class="reference">{{ $assessment->reference_number }}</span></p>
