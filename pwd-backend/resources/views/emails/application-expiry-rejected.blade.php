...
<head>
    <meta charset="utf-8">
    <title>Application Rejected - Expired</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #E74C3C;">Your PWD Application Has Been Rejected</h2>
        
        <p>Dear {{ $firstName }} {{ $lastName }},</p>
        
        <p>We regret to inform you that your PWD application with reference number <strong>{{ $referenceNumber }}</strong> has been automatically rejected due to expiration.</p>
        ...
        <div style="background-color: #F8D7DA; border-left: 4px solid #E74C3C; padding: 15px; margin: 20px 0;">
            ...
            <p style="margin: 5px 0 0 0;"><strong>Reason:</strong> Application remained in pending status beyond the allowed holding duration</p>
        </div>
        
        <p>Your application remained in pending status beyond the allowed holding duration and has been automatically rejected by the system.</p>
