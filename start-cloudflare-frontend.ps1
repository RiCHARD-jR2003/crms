...
Write-Host "Frontend URL: https://speakers-calendar-avi-assumes.trycloudflare.com" -ForegroundColor Green
Write-Host ""
...
Write-Host "Cloudflare Frontend: https://speakers-calendar-avi-assumes.trycloudflare.com" -ForegroundColor White
Write-Host ""
