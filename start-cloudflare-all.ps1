...
Write-Host "  Backend:  https://fundamentals-window-groove-experiences.trycloudflare.com" -ForegroundColor Green
Write-Host "  Frontend: https://quote-licensing-kurt-desktops.trycloudflare.com" -ForegroundColor Green
Write-Host ""
