...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'Cloudflare Tunnel - Backend' -ForegroundColor Green; Write-Host 'Tunneling: http://localhost:8000 -> https://labs-usual-pro-providing.trycloudflare.com' -ForegroundColor Cyan; .\cloudflared.exe tunnel --url http://localhost:8000"
Start-Sleep -Seconds 2

# Start Cloudflare Tunnel for Frontend
Write-Host "Starting Cloudflare Tunnel for Frontend..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'Cloudflare Tunnel - Frontend' -ForegroundColor Green; Write-Host 'Tunneling: http://localhost:3000 -> https://respiratory-nam-quantitative-minister.trycloudflare.com' -ForegroundColor Cyan; .\cloudflared.exe tunnel --url http://localhost:3000"
...
Write-Host "  Backend:  https://labs-usual-pro-providing.trycloudflare.com" -ForegroundColor Green
Write-Host "  Frontend: https://respiratory-nam-quantitative-minister.trycloudflare.com" -ForegroundColor Green
Write-Host ""
