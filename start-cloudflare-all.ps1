...
Write-Host "  Backend:  https://attachments-sand-gave-shame.trycloudflare.com" -ForegroundColor Green
Write-Host "  Frontend: https://uniprotkb-designated-cases-walked.trycloudflare.com" -ForegroundColor Green
Write-Host ""
