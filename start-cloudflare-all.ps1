...
Write-Host "  Backend:  https://refurbished-consultancy-alcohol-navigator.trycloudflare.com" -ForegroundColor Green
Write-Host "  Frontend: https://casey-impossible-odds-alexander.trycloudflare.com" -ForegroundColor Green
Write-Host ""
