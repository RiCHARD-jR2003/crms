...
Write-Host "Backend URL: https://labs-usual-pro-providing.trycloudflare.com" -ForegroundColor Green
Write-Host ""
...
Write-Host "Cloudflare Backend: https://labs-usual-pro-providing.trycloudflare.com" -ForegroundColor White
Write-Host ""
