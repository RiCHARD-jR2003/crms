...
Write-Host "Backend URL: https://spyware-justice-knock-nutrition.trycloudflare.com" -ForegroundColor Green
Write-Host ""
...
Write-Host "Cloudflare Backend: https://spyware-justice-knock-nutrition.trycloudflare.com" -ForegroundColor White
Write-Host ""
