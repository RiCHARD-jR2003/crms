...
Write-Host "Backend URL: https://refurbished-consultancy-alcohol-navigator.trycloudflare.com" -ForegroundColor Green
Write-Host ""
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'Cloudflare Tunnel - Backend' -ForegroundColor Green; Write-Host 'Tunneling: http://localhost:8000 -> https://refurbished-consultancy-alcohol-navigator.trycloudflare.com' -ForegroundColor Cyan; .\cloudflared.exe tunnel --url http://localhost:8000"
...
Write-Host "Cloudflare Backend: https://refurbished-consultancy-alcohol-navigator.trycloudflare.com" -ForegroundColor White
Write-Host ""
